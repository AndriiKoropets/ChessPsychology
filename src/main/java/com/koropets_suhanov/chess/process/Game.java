        ...
        if (rock.isOpportunityToCastling() && king.isOpportunityToCastling()){
            if (color == Color.BLACK){
                if (!Board.getFieldsUnderWhiteInfluence().contains(f8) && !Board.getFieldsUnderWhiteInfluence().contains(g8) &&
                    ...
                    shortCastling = ProcessingUtils.createTurn(castlingTuple, null, ProcessingUtils.shortCastling, false, false, false, null, numberOfTurn);
                }
            }else{
        ...
        if (rock.isOpportunityToCastling() && king.isOpportunityToCastling()){
            if (color == Color.BLACK){
                if (!Board.getFieldsUnderWhiteInfluence().contains(b8) && !Board.getFieldsUnderWhiteInfluence().contains(c8) &&
                    ...
                    longCastling = ProcessingUtils.createTurn(castlingTuple, null, ProcessingUtils.longCastling, false, false, false,  null, numberOfTurn);
                }
            }else {
