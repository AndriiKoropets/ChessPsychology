...
public class EstimatePosition {
    ...
    static Parameter estimate(Turn turn, Set<Turn> possibleTurns, Color side) {
        ...
        Tuple2<Integer, List<FigureToField>> fifthParamToInvolvedFigures = new Tuple2<>(estimatedFifthParameter._2 - firstParam, estimatedFifthParameter._1.getFigureToDestinationField());
        Tuple2<Integer, List<FigureToField>> sixthParamToInvolvedFigures = new Tuple2<>(estimatedSixthParameter._2 - secondParam, estimatedSixthParameter._1.getFigureToDestinationField());
        Tuple2<Integer, List<FigureToField>> seventhParamToInvolvedFigures = new Tuple2<>(estimatedSeventhParameter._2 - thirdParam, estimatedSeventhParameter._1.getFigureToDestinationField());
        Tuple2<Integer, List<FigureToField>> eighthParamToInvolvedFigures = new Tuple2<>(estimatedEighthParameter._2 - fourthParam, estimatedEighthParameter._1.getFigureToDestinationField());
